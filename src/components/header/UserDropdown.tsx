    ...
    <div className="relative">
      ...
      >
        <div className="flex items-start gap-3 pb-4 border-b border-gray-200 dark:border-gray-800">
          {/* Avatar in dropdown */}
          <div className="flex items-center justify-center flex-shrink-0 w-12 h-12 overflow-hidden rounded-full bg-gradient-to-br from-blue-500 to-purple-600">
          ...
          <div className="flex-1 min-w-0">
            <span className="block font-medium text-gray-700 truncate text-theme-sm dark:text-gray-400">
              {user?.name || "User"}
            </span>
            <span className="block mt-0.5 text-theme-xs text-gray-500 dark:text-gray-400 truncate">
              {user?.email || "user@example.com"}
            </span>
            {user?.role && (
              <span className="inline-block px-2 py-1 mt-1.5 text-xs font-medium text-blue-600 bg-blue-100 rounded-full dark:bg-blue-900/20 dark:text-blue-400">
