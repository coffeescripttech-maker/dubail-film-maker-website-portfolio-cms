...
-- SQLite version with Thumbnail & Film Arrangement Support
-- Last Updated: 2026-01-25
-- =====================================================

-- =====================================================
-- PROJECTS TABLE (with thumbnail support)
-- =====================================================
CREATE TABLE IF NOT EXISTS projects (
  ...
  -- Thumbnail support columns (added 2026-01-25)
  thumbnail_url TEXT,
  thumbnail_type TEXT, -- 'custom', 'video_frame', 'default'
  thumbnail_timestamp REAL, -- for video frame captures (in seconds)
  thumbnail_metadata TEXT, -- JSON: {width, height, size, formats}
